**MoneyForensics
Graph-Based Financial Crime & Money Muling Detection Engine
...
Time Complexity: O(V + E)
Worst Case: Traverses entire graph
...
Rapid Multi-hop Chains	25%
Circular Ring Presence	20%
High Incoming/Outgoing Ratio	15%
Time-based Burst Activity	15%
...
git clone https://github.com/your-username/moneyforensics.git
cd moneyforensics
...
👉 https://moneyforensics.vercel.app
